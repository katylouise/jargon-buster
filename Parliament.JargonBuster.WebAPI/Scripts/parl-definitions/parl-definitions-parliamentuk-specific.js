$(document).ready(function () {
    ...
    if (typeof(Cookies.get("hasVisited")) === "undefined") {
        setTimeout(function () {
            ...
            var modal = "<div id='modal' style='display: none;'><iframe src='https://docs.google.com/forms/d/1QjEi363DhFkG7sKRVhE8PRVUAgPjo-j8Neezge0Tg1A/viewform?embedded=true' width='410' height='500' frameborder='0' marginheight='0' marginwidth='0'>Loading...</iframe></div>";
            $('body').append(modal);
            $('#modal').modal();
        }, 40000);
    }
...
function ParlJargonBusterParliamentUK(options) {
    ...
    function addDefinitionsToggleLink() {
        $("#navigation #level-1").append("<li class='parl-definitions-toggle-list'><a class='parl-definitions'>Definitions <img class='info-icon' src='https://dl.dropboxusercontent.com/u/10259375/hosted%20images/question-icon-2_26x26.svg'></a></li>");
